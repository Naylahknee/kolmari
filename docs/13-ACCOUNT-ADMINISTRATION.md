# Kolmari Account Administration
...
Kolmari requires two separate systems:
...
Users should be able to request a copy of account-related data associated with their Kolmari account.
...
- which Kolmari data will be deleted
...
10. Update `/docs/kolmari/CURRENT-STATE.md`.
