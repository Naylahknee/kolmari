# Kolmari Interaction Design

## Purpose

This document defines how Kolmari should behave as users move through:
...
For visual identity, typography, colors, and design tokens, use the other Kolmari design documents.

---

# Core Interaction Principle

Kolmari should help users move from uncertainty to clarity.
...
The core Kolmari experience has four stages.
...
Kolmari interactions should feel:
...
Kolmari interactions should not feel:
...
Kolmari uses progressive depth.
...
The Kolmari experience has three geographic interaction levels.
...
# Kolmari Plan Transition

## Starting a Plan

A user may begin a Kolmari Plan from:
...
Explore the Kolmari World Map to begin.
```

```text
Complete your Kolmari Profile to receive personalized country ordering.
...
```text
/your-world?region=europe
/your-world?country=portugal
...
7. Save the country.
8. Begin or update a Kolmari Plan.
...
12. Update `/docs/kolmari/CURRENT-STATE.md`.
