...
The Kolmari World Map is the geographic research and discovery layer of Kolmari.
...
7. Update `/docs/kolmari/CURRENT-STATE.md`.
...
Regional imagery may be used to give the map a distinctive Kolmari identity.
