                ...
                <div className="flex items-start justify-between gap-2">
                  ...
                  {profileComplete && typeof detail.match === 'number' && (
                    <p className="shrink-0 text-[14px] font-bold text-gold-deep">
                      {detail.match}%
                      <span className="ml-1 text-[10px] font-medium text-muted">Nexit Score</span>
                    </p>
                  )}
                </div>
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 max-w-2xl text-sm leading-6 text-muted">
          Compare general Pathway and cost information. Personalized matches require a completed Nexit Profile.
        </p>
      </div>
