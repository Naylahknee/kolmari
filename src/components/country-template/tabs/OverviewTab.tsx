      ...
      <div className="tabpanel on" id="p-overview">
              ...
              <section className="card-surface sec" id="top-cities">
                ...
                <div className="cities">
                  ...
                  <article className="city">
                    <div className="city-map">
                      <span className="cmap"><CityCardImage imageSrc="/api/country-asset?slug=portugal&type=city&city=porto" cityName="Porto" countryName="Portugal" countryCode="PT" className="city-photo" /></span>
                      <span className="city-flag"><span className="flag sm" role="img" aria-label="Portugal"><svg viewBox="0 0 900 600" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><rect width="360" height="600" fill="#006600" /><rect x="360" width="540" height="600" fill="#DA291C" /><g transform="translate(360 300)" fill="none" stroke="#FFE900" strokeWidth="15"><circle r="108" /><ellipse rx="108" ry="42" /><ellipse rx="42" ry="108" /><ellipse rx="108" ry="42" transform="rotate(38)" /><ellipse rx="108" ry="42" transform="rotate(-38)" /><path d="M-108 0H108" /></g><g transform="translate(360 300)"><path d="M-52-70h104v78c0 44-38 68-52 76-14-8-52-32-52-76z" fill="#DA291C" stroke="#fff" strokeWidth="13" /><path d="M-31-46h62v54c0 28-22 44-31 50-9-6-31-22-31-50z" fill="#fff" /><g fill="#003399"><rect x="-9" y="-38" width="18" height="26" rx="3" /><rect x="-9" y="12" width="18" height="26" rx="3" /><rect x="-34" y="-13" width="18" height="26" rx="3" /><rect x="16" y="-13" width="18" height="26" rx="3" /></g></g></svg><img src="/flags/pt.svg" alt="" /></span></span><span className="city-tag">Best value</span>
                    </div>
                    <div className="city-body">
                  ...
                  <article className="city">
                    <div className="city-map">
                      <span className="cmap"><CityCardImage imageSrc="/api/country-asset?slug=portugal&type=city&city=funchal" cityName="Funchal" countryName="Portugal" countryCode="PT" className="city-photo" /></span>
                      <span className="city-flag"><span className="flag sm" role="img" aria-label="Portugal"><svg viewBox="0 0 900 600" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><rect width="360" height="600" fill="#006600" /><rect x="360" width="540" height="600" fill="#DA291C" /><g transform="translate(360 300)" fill="none" stroke="#FFE900" strokeWidth="15"><circle r="108" /><ellipse rx="108" ry="42" /><ellipse rx="42" ry="108" /><ellipse rx="108" ry="42" transform="rotate(38)" /><ellipse rx="108" ry="42" transform="rotate(-38)" /><path d="M-108 0H108" /></g><g transform="translate(360 300)"><path d="M-52-70h104v78c0 44-38 68-52 76-14-8-52-32-52-76z" fill="#DA291C" stroke="#fff" strokeWidth="13" /><path d="M-31-46h62v54c0 28-22 44-31 50-9-6-31-22-31-50z" fill="#fff" /><g fill="#003399"><rect x="-9" y="-38" width="18" height="26" rx="3" /><rect x="-9" y="12" width="18" height="26" rx="3" /><rect x="-34" y="-13" width="18" height="26" rx="3" /><rect x="16" y="-13" width="18" height="26" rx="3" /></g></g></svg><img src="/flags/pt.svg" alt="" /></span></span><span className="city-tag">Island living</span>
                    </div>
                    <div className="city-body">
                  ...
                  <article className="city">
                    <div className="city-map">
                      <span className="cmap"><CityCardImage imageSrc="/api/country-asset?slug=portugal&type=city&city=braga" cityName="Braga" countryName="Portugal" countryCode="PT" className="city-photo" /></span>
                      <span className="city-flag"><span className="flag sm" role="img" aria-label="Portugal"><svg viewBox="0 0 900 600" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><rect width="360" height="600" fill="#006600" /><rect x="360" width="540" height="600" fill="#DA291C" /><g transform="translate(360 300)" fill="none" stroke="#FFE900" strokeWidth="15"><circle r="108" /><ellipse rx="108" ry="42" /><ellipse rx="42" ry="108" /><ellipse rx="108" ry="42" transform="rotate(38)" /><ellipse rx="108" ry="42" transform="rotate(-38)" /><path d="M-108 0H108" /></g><g transform="translate(360 300)"><path d="M-52-70h104v78c0 44-38 68-52 76-14-8-52-32-52-76z" fill="#DA291C" stroke="#fff" strokeWidth="13" /><path d="M-31-46h62v54c0 28-22 44-31 50-9-6-31-22-31-50z" fill="#fff" /><g fill="#003399"><rect x="-9" y="-38" width="18" height="26" rx="3" /><rect x="-9" y="12" width="18" height="26" rx="3" /><rect x="-34" y="-13" width="18" height="26" rx="3" /><rect x="16" y="-13" width="18" height="26" rx="3" /></g></g></svg><img src="/flags/pt.svg" alt="" /></span></span><span className="city-tag">Lowest cost</span>
                    </div>
                    <div className="city-body">
