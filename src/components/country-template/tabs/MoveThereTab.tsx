      ...
      <div className="tabpanel on" id="p-move">
              ...
              <section className="card-surface sec">
                <div className="sec-head">
                  ...
                  <Link className="sec-link" href="/nexit-plan">Open in Kolmari Plan <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" width="13" height="13"><path d="M5 12h14M13 6l6 6-6 6" /></svg></Link>
                </div>
                <div className="two">
                  <div>
