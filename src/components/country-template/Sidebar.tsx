  ...
  return (
    <aside className="rail">
        ...
        <nav aria-label="Main">
          ...
          <Link className={`sb-item${active('/pathways') ? ' active' : ''}`} href="/pathways"><svg className="ic" viewBox="0 0 24 24" fill="none" stroke="currentColor"><circle cx="6" cy="6" r="2.5" /><circle cx="18" cy="18" r="2.5" /><path d="M8.5 6H15a3 3 0 010 6H9a3 3 0 000 6h6.5" /></svg><span className="lbl">Nexit Pathways</span></Link>
          <Link className={`sb-item${active('/nexit-plan') ? ' active' : ''}`} href="/nexit-plan"><svg className="ic" viewBox="0 0 24 24" fill="none" stroke="currentColor"><rect x="4" y="3" width="16" height="18" rx="2" /><path d="M8 3v18M11 8h6M11 12h4" /></svg><span className="lbl">Nexit Plan</span></Link>
          <Link className={`sb-item${active('/cost-calculator') ? ' active' : ''}`} href="/cost-calculator"><svg className="ic" viewBox="0 0 24 24" fill="none" stroke="currentColor"><rect x="4" y="3" width="16" height="18" rx="2" /><path d="M8 7h8M8 12h.01M12 12h.01M16 12h.01M8 16h.01M12 16h.01M16 16h.01" /></svg><span className="lbl">Cost Calculator</span></Link>
          <Link className={`sb-item${active('/greenbook') ? ' active' : ''}`} href="/greenbook"><svg className="ic" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M3 5a2 2 0 012-2h5v18H5a2 2 0 01-2-2zM21 5a2 2 0 00-2-2h-5v18h5a2 2 0 002-2z" /></svg><span className="lbl">Greenbook</span></Link>
          <Link className={`sb-item${active('/documents') ? ' active' : ''}`} href="/documents"><svg className="ic" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M14 3H7a2 2 0 00-2 2v14a2 2 0 002 2h10a2 2 0 002-2V8z" /><path d="M14 3v5h5M9 13h6M9 17h4" /></svg><span className="lbl">Documents</span></Link>

          <div className="sb-div"></div>
          <p className="sb-label">Settings</p>
          <Link className={`sb-item${active('/settings') ? ' active' : ''}`} href="/settings"><svg className="ic" viewBox="0 0 24 24" fill="none" stroke="currentColor"><circle cx="12" cy="12" r="3" /><path d="M19.4 15a1.6 1.6 0 00.3 1.8l.1.1a2 2 0 11-2.8 2.8l-.1-.1a1.6 1.6 0 00-1.8-.3 1.6 1.6 0 00-1 1.5v.2a2 2 0 11-4 0v-.1a1.6 1.6 0 00-1-1.5 1.6 1.6 0 00-1.8.3l-.1.1a2 2 0 11-2.8-2.8l.1-.1a1.6 1.6 0 00.3-1.8 1.6 1.6 0 00-1.5-1H2a2 2 0 010-4h.1a1.6 1.6 0 001.5-1 1.6 1.6 0 00-.3-1.8l-.1-.1a2 2 0 112.8-2.8l.1.1a1.6 1.6 0 001.8.3H9a1.6 1.6 0 001-1.5V2a2 2 0 014 0v.1a1.6 1.6 0 001 1.5 1.6 1.6 0 001.8-.3l.1-.1a2 2 0 112.8 2.8l-.1.1a1.6 1.6 0 00-.3 1.8V9a1.6 1.6 0 001.5 1h.2a2 2 0 010 4h-.1a1.6 1.6 0 00-1.5 1z" /></svg><span className="lbl">Settings</span></Link>
          <Link className={`sb-item${active('/profile-wizard') ? ' active' : ''}`} href="/profile-wizard"><svg className="ic" viewBox="0 0 24 24" fill="none" stroke="currentColor"><circle cx="12" cy="8" r="4" /><path d="M4 21a8 8 0 0116 0" /></svg><span className="lbl">Profile</span></Link>
        </nav>
