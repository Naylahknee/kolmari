  ...
  return (
    <div className="space-y-5">
      <section className="card-surface p-6">
        ...
        <p className="mt-2 text-sm text-muted">Local job market overview. Personalization for your specific occupation is available when your Profile is complete.</p>
      </section>
