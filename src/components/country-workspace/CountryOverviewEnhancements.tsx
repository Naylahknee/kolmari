    ...
    <div className="mt-5">
      <section className="card-surface p-6" aria-labelledby="readiness-heading">
        ...
        <div className="mt-1 flex flex-wrap items-end justify-between gap-4">
          <h2 id="readiness-heading" className="text-xl font-bold text-navy">Move Readiness</h2>
        ...
        {readiness.overall === null ? (
          <p className="mt-3 max-w-2xl text-sm leading-6 text-muted">
            Complete your profile and begin your research to calculate Move Readiness. Documents and meaningful research activity are not yet assessed, so Kolmari will not manufacture an overall percentage.
          </p>
        ) : (
          <div
            className="mt-5 h-4 overflow-hidden rounded-full bg-line"
            role="progressbar"
            aria-label="Overall Move Readiness"
            aria-valuemin={0}
            aria-valuemax={100}
