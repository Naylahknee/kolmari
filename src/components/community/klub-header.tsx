...
/**
 * KlubHeader — page header for the Kolmari Club community page.
...
export function KlubHeader() {
  return (
    <header>
      ...
      <h1 className="mt-1 text-2xl font-bold text-navy sm:text-3xl">Kolmari Club</h1>
...
export function KlubEmptyState() {
  return (
    <section className="mt-6 overflow-hidden rounded-[var(--radius-card)] border border-line bg-white p-7">
      ...
      <h2 className="mt-4 text-lg font-bold text-navy">Kolmari Club is coming.</h2>
