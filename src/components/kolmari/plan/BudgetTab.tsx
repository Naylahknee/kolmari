  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-5 sm:grid-cols-3">
        ...
        <Stat label="Categories entered" value={`${entered} of ${BUDGET_KEYS.length}`} hint={entered === BUDGET_KEYS.length ? 'Budget complete' : 'Keep building your estimate'} />
        <Stat label="Currency" value="USD" hint="Display preference" />
      </div>
