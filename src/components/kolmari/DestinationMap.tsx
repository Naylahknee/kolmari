...
import { REGION_MAP_LABELS, REGION_MAP_SHAPES, regionList, type RegionSlug } from '@/lib/destinations-data'
...
export default function DestinationMap({ profile }: { profile: MapProfile }) {
  return <section className="overflow-hidden rounded-[24px] border border-white/10 bg-navy-deep p-3 shadow-card sm:p-5" aria-label="Illustrated world region map">
    <svg viewBox="0 0 1000 520" role="img" aria-labelledby="world-map-title world-map-desc" className="h-auto w-full">
      <desc id="world-map-desc">Six selectable world regions filled with relocation imagery.</desc>
