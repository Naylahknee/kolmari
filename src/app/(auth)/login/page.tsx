  ...
  return (
    <main className="grid min-h-screen place-items-center bg-canvas px-5 py-12">
      <section className="card-surface w-full max-w-md p-7 sm:p-10">
        ...
        <h1 className="mt-2 font-display text-4xl font-bold text-navy">Continue your Nexit Plan.</h1>
        <p className="mt-3 text-sm leading-6 text-muted">
          Sign in to return to your saved Pathways, budget, and Nexit Tracker.
        </p>
