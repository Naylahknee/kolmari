    ...
    <div>
      ...
      <section className="mt-6 rounded-[var(--radius-card)] border border-line bg-canvas p-6" aria-label="Community-reported experiences">
        ...
        <p className="mt-1 text-sm text-muted">
          Verified member stories are not yet available. Nexit will clearly label each submission as Editorial context, Verified resource, or Community-reported experience before publishing.
        </p>
      </section>
      ...
      <section className="mt-6 rounded-[var(--radius-card)] bg-navy p-7 text-white sm:flex sm:items-center sm:justify-between sm:gap-6">
        <div>
          ...
          <h2 className="mt-3 text-xl font-bold">Apply context to a specific Nextination</h2>
