# Kolmari geographic data

`continents.geojson` groups Natural Earth 1:110m Admin 0 country boundaries into
the six Kolmari regions. Natural Earth data is public domain. The feature
properties (`slug`, `label`, `countryCount`, and `matchLabel`) are Kolmari-owned
