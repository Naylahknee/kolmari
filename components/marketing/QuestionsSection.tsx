      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="mx-auto mb-12 max-w-4xl text-center lg:mb-16">
          ...
          <h2
            ...
            className="font-serif text-4xl tracking-tight text-white sm:text-5xl lg:text-6xl"
          >
          ...
          {questions.map(({ question, icon: Icon }, index) => (
            ...
            >
              <div className="flex h-full flex-col">
                ...
                <h3 className="max-w-[19rem] font-serif text-2xl leading-snug tracking-tight sm:text-[1.7rem]">
                  {question}
                </h3>
